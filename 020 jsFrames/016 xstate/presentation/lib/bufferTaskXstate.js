...
const BufferTastMechine = (0, _xstate.Machine)({
  id: 'bufferTask',
  initial: 'idle',
  states: {
    idle: {
...
class BufferTask {
  constructor(callback = () => {}, timeout = 200, taskName = 'defalutTask') {
    ...
    this.machine = (0, _xstate.interpret)(BufferTastMechine.withContext({
      taskName,
      timeout,
      tasks: [],
      timer: null,
