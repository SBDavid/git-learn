...
export default class BIPMD5Encode {
	...
	constructor() {
		if (!BIPMD5Encode.isSingleton) {
			throw new Error('只能用 getInstance() 来获取实例...');
		}
	}

	static getInstance() {
		if (!BIPMD5Encode.instance) {
			BIPMD5Encode.isSingleton = true;
			BIPMD5Encode.instance = new BIPMD5Encode();
			BIPMD5Encode.isSingleton = false;
		}
		return BIPMD5Encode.instance;
	}
